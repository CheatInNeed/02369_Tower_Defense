...
class CustomEnemyTest {
    ...
    void constructorSetsMaxAndCurrentHealth() {
        Enemy enemy = EnemyFactory.createEnemy("custom", 1.25f, -3.5f, 42);
    ...
    void canChangeHealth() {
        Enemy enemy = EnemyFactory.createEnemy("custom", 0f, 0f, 5);
    ...
    void setPositionWorks() {
        Enemy enemy = EnemyFactory.createEnemy("custom", 0f, 0f, 10);
